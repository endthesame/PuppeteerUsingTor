module.exports = function extractMetadata() {
    ...
    let mf_doi = document.querySelector('.issue-header')? document.querySelector('.issue-header').innerText.trim().match(/DOI: (10.*)/)? document.querySelector('.issue-header').innerText.trim().match(/DOI: (10.*)/)[1] : "" : "";
    // if (mf_doi == ""){
    ...
    // }
    let mf_book = document.querySelector('.issue-header .common-title')? document.querySelector('.issue-header .common-title').innerText.trim() : "";
    //let subtitle = "";
    //let book_series = ""; 
